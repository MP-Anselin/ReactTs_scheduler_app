...
import {MonthsList} from "../enums/months-list.enum";
...
const Header: React.FC = () => {
    ...
    return (
        <header>
            <div className="month">
                <h1>{MonthsList[date.getMonth()]} {date.getFullYear()}</h1>
            </div>
            <div className="nav">
                <button className="button button-white" onClick={() => addMonth(-1)}>
                    <svg width="52px" height="52px" viewBox="0 0 52 52" data-name="Layer 1" id="Layer_1"
